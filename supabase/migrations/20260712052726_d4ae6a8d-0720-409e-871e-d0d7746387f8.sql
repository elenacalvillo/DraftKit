...
AS $function$
  ...
  base AS (
    ...
    UNION
    -- Requester (outgoing pitches or self-assigned chapters)
    ...
    UNION
    -- Project owner: chapters within a book they own
  ...
  WHERE (SELECT uid FROM me) IS NOT NULL
    -- Global rule: hide solo book project chapters unless actually shared.
    AND (
